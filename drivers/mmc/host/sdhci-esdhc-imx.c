...
static int sdhci_esdhc_imx_probe(struct platform_device *pdev)
{
	...
	pr_debug("enter sdhci_esdhc_imx_probe\n");
	...
	pr_debug("leave sdhci_esdhc_imx_probe\n");
	return 0;
...
free_sdhci:
	...
	pr_debug("leave sdhci_esdhc_imx_probe(error)\n");
	return err;
}
...
static struct platform_driver sdhci_esdhc_imx_driver = {
	...
	.probe		= my_sdhci_esdhc_imx_probe,
	.remove		= my_sdhci_esdhc_imx_remove,
};
